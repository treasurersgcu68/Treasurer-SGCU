const CACHE_VERSION = "20260527-hide-external-axis-loading-1";
const CACHE_PREFIX = "treasurer-sgcu-shell";
const CACHE_NAME = `${CACHE_PREFIX}-${CACHE_VERSION}`;
const APP_SHELL_URLS = [
  "./",
  "./index.html",
  "./css/style.css?v=20260527-hide-external-axis-loading-1",
  ...
  "./js/core/app.core.js?v=20260527-hide-external-axis-loading-1",
