const CACHE_VERSION = "20260628-dashboard-debt-active-only-1";
const CACHE_PREFIX = "treasurer-sgcu-shell";
const CACHE_NAME = `${CACHE_PREFIX}-${CACHE_VERSION}`;
const APP_SHELL_URLS = [
  "./",
  "./index.html",
  "./css/style.css?v=20260627-dashboard-mobile-overflow-1",
  ...
  "./js/core/app.feature-loader.js?v=20260628-dashboard-debt-active-only-1",
  "./js/core/app.init.js?v=20260627-project-budget-comparison-chart-1",
