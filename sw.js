const CACHE_VERSION = "20260510-project-mobile-calendar-back-1";
const CACHE_PREFIX = "treasurer-sgcu-shell";
const CACHE_NAME = `${CACHE_PREFIX}-${CACHE_VERSION}`;
const APP_SHELL_URLS = [
  "./",
  "./index.html",
  "./css/style.css?v=20260510-project-mobile-calendar-back-1",
  "./css/core/base.css",
  ...
  "./js/core/app.init.js?v=20260510-project-mobile-calendar-back-1",
